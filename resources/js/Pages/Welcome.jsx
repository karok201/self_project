...
export default function Welcome(props) {
    ...
    const items = [{value: "Главная", href: "/main", icon:"anchor"}, {value: "Услуги", href: "/service", icon:"api"}, {value: "Магазин", href: "/shop", icon:"android"}]
    return (
        <>
            <Head title="Welcome" />
            <nav className="px-16 bg-gray-800 flex h-20 items-center justify-between text-white sticky z-50">
                <div className='cursor-pointer burger-btn' onClick={() => setActive(!menuActive)}>
                    <span />
                </div>
            ...
            <Menu active={menuActive} setActive={setActive} header={"Бургер меню"} items={items}/>
        </>
    );
}
